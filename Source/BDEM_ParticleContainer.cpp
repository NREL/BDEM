            ...
            const Real cb_force, const Real cb_torq, const int cb_dir)
{
    ...
    for(MFIter mfi = MakeMFIter(lev); mfi.isValid(); ++mfi)
    {
                ...
                AMREX_GPU_DEVICE (int i) noexcept
        {
            ...
            p.rdata(realData::fx_con) = zero;
            p.rdata(realData::fy_con) = zero;
            p.rdata(realData::fz_con) = zero;
            p.rdata(realData::fx_BS) = zero;
            p.rdata(realData::fy_BS) = zero;
            p.rdata(realData::fz_BS) = zero;
            p.rdata(realData::fx_LB) = zero;
            p.rdata(realData::fy_LB) = zero;
            p.rdata(realData::fz_LB) = zero;
            p.rdata(realData::fx_sjkr) = zero;
            p.rdata(realData::fy_sjkr) = zero;
            p.rdata(realData::fz_sjkr) = zero;
            p.rdata(realData::fx_wall) = zero;
            p.rdata(realData::fy_wall) = zero;
            p.rdata(realData::fz_wall) = zero;
...
void BDEMParticleContainer::writeParticles(const int n, const int bonded_sphere_particles, const std::string pltprefix)
{
    ...
    real_data_names.push_back("fx_con");
    real_data_names.push_back("fy_con");
    real_data_names.push_back("fz_con");
    real_data_names.push_back("fx_BS");
    real_data_names.push_back("fy_BS");
    real_data_names.push_back("fz_BS");
    real_data_names.push_back("fx_LB");
    real_data_names.push_back("fy_LB");
    real_data_names.push_back("fz_LB");
    real_data_names.push_back("fx_sjkr");
    real_data_names.push_back("fy_sjkr");
    real_data_names.push_back("fz_sjkr");
    real_data_names.push_back("fx_wall");
    real_data_names.push_back("fy_wall");
    real_data_names.push_back("fz_wall");
    ...
    writeflags_real[realData::fx_con]=1;
    writeflags_real[realData::fy_con]=1;
    writeflags_real[realData::fz_con]=1;
    writeflags_real[realData::fx_BS]=1;
    writeflags_real[realData::fy_BS]=1;
    writeflags_real[realData::fz_BS]=1;
    writeflags_real[realData::fx_LB]=1;
    writeflags_real[realData::fy_LB]=1;
    writeflags_real[realData::fz_LB]=1;
    writeflags_real[realData::fx_sjkr]=1;
    writeflags_real[realData::fy_sjkr]=1;
    writeflags_real[realData::fz_sjkr]=1;
    writeflags_real[realData::fx_wall]=1;
    writeflags_real[realData::fy_wall]=1;
    writeflags_real[realData::fz_wall]=1;
