...
if __name__ == "__main__":
    ...
    xdelta = x_f - x_i
    delta_max = max(xdelta)
    delta_norm = xdelta/delta_max

    xnorm = (x_f - 0.3) / L

    outfile.write("%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e\n%e\t%e"%(xnorm[0], delta_norm[0], 
                                                                                                    xnorm[1], delta_norm[1], 
                                                                                                    xnorm[2], delta_norm[2], 
                                                                                                    xnorm[3], delta_norm[3], 
                                                                                                    xnorm[4], delta_norm[4], 
                                                                                                    xnorm[5], delta_norm[5], 
                                                                                                    xnorm[6], delta_norm[6], 
                                                                                                    xnorm[7], delta_norm[7], 
                                                                                                    xnorm[8], delta_norm[8], 
                                                                                                    xnorm[9], delta_norm[9]))
